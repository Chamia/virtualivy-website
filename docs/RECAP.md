...
A living status doc for the website + SEO project. For the action checklist, see [SEO-PLAYBOOK.md](SEO-PLAYBOOK.md).
...
- **Stack:** static HTML/CSS/JS · GitHub Pages + Cloudflare · clean (extensionless) URLs · 35 pages.

---

## DONE — on-site (all live & pushed)
- **35 pages:** homepage, 12 service pages, 2 Nairobi location pages, 2 industry pages, 10 articles + 1 pillar guide, about/services/insights/faq/contact, legal.
