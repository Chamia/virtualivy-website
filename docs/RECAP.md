...
- **Stack:** static HTML/CSS/JS · GitHub Pages + Cloudflare · clean (extensionless) URLs · 45 pages.

---

## DONE — on-site (all live & pushed)
- **45 pages:** homepage, 12 service pages, 2 Nairobi location pages, 2 industry pages, 10 articles + 1 pillar guide, about/services/insights/faq/contact, legal.
